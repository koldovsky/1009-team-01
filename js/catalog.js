            ...
            if (bouquet.oldPrice) {
                ...
                <div class="catalog-item">
                    <div class="catalog-item__wrapper">
                        <a id="${bouquet.id}" href="bouquet-page.html"><img src="${bouquet.imgSrc}" alt="${bouquet.name}" class="catalog-item__image" /></a>
                        <a href="bouquet-page.html" class="catalog-item__name">${bouquet.name}</a>
                ...
                <div class="catalog-item">
                    <div class="catalog-item__wrapper">
                        <a href="bouquet-page.html"><img src="${bouquet.imgSrc}" alt="${bouquet.name}" class="catalog-item__image" /></a>
                        <a href="bouquet-page.html" class="catalog-item__name">${bouquet.name}</a>
